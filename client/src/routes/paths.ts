...
export const ROUTES = {
  ...
  personalGrowthHabitsProgress: '/personal/growth/habits/progress',
  personalGrowthHabitDetail: (id: string) => `/personal/growth/habits/${id}`,
  ...
  personalSecurity: '/personal/profile/security',
  personalFeedback: '/personal/profile/feedback',
  personalPrivacy: '/personal/profile/privacy',
  personalRanking: '/personal/ranking',
  personalRankingProfile: (id: string) => `/personal/ranking/${id}`,
  ...
  platformTelegramBot: '/platform/telegram/bot',
  platformTelegramStart: '/platform/telegram/start',
  platformTelegramMenu: '/platform/telegram/menu',
  platformTelegramBroadcast: '/platform/telegram/broadcast',
  platformTelegramAutomations: '/platform/telegram/automations',
  platformTelegramStats: '/platform/telegram/stats',
  platformTelegramUsers: '/platform/telegram/users',
  platformUsage: '/platform/usage',
  platformUsageUsers: '/platform/usage/users',
  platformUsageUser: (id: string) => `/platform/usage/users/${id}`,
  platformUsageFeatures: '/platform/usage/features',
  platformUsageRetention: '/platform/usage/retention',
  platformUsageSessions: '/platform/usage/sessions',
  billing: '/billing',
  ...
  /** Store-scoped business notification inbox. Isolated from /personal/notifications. */
